...
CREATE TABLE urls (
    ...
    path TEXT NOT NULL,
    url_hash VARCHAR(64) NOT NULL UNIQUE, -- SHA256 hash for efficient lookups
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
-- Elements table to store unique element names
...
('ul'), ('li'), ('table'), ('tr'), ('td'), ('th'), ('form'), ('input'), ('button'),
('script'), ('style'), ('meta'), ('link'), ('title'), ('body'), ('html'), ('head');
